...
object Trainer {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val df: DataFrame = spark
      .read
      .parquet("/Users/anthonyhoudaille/Desktop/TP_ParisTech_2017_2018_starter/data/prepared_trainingset")
    ...
    val TFVector = new CountVectorizer().setInputCol("filtered").setOutputCol("rawFeatures").fit(df)
    ...
    val evaluator = new MulticlassClassificationEvaluator()
      .setLabelCol("final_status")
      .setPredictionCol("predictions")
      .setMetricName("f1-score")

    val trainValidationSplit = new TrainValidationSplit()
      .setEstimator(logisticreg)
